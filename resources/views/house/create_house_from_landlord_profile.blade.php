                    ...
                    {{Form::open(array('route' => 'store_house', 'method' => 'POST', 'files'=>true))}}
                        ...
                        <div class="form-group row">
                            <div class="col-md-7">
                                ...
                                <textarea rows="4" cols="20" class="form-control" name="description" placeholder="Description should be based on exact location and landmarks close to the property" value="{{ old('description')}}"></textarea>
                            </div>
                            <div class="form-group col-md-5">
